...
# Tekrar eden kelimeleri hesaplama seçeneği
treemap_recalculate = st.checkbox("Recalculate Repeating Words")
...
if uploaded_files:
    ...
    # Eğer "Recalculate Repeating Words" seçildiyse tekrar eden kelimeleri hesapla
